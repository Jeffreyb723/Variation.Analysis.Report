...
{
    /// <summary>
    /// Represents a Leader node in the XML results from a Variation Analysis (VSA) Model.
    /// </summary>
    /// <remarks></remarks>
    [Serializable]
    public class Leader : IXmlSerializable
    {
        ...
        {
            if (reader.MoveToContent() == XmlNodeType.Element && reader.LocalName == "Leader")
            {
